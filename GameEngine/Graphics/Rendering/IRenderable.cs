...
public interface IRenderable : IRuntimeComponent
{
    ...
    /// Used for spatial partitioning and hierarchical culling.
    /// Return false to skip entire subtrees (e.g., distant regions, inactive areas).
    /// </summary>
    bool ShouldRenderChildren { get; }
}