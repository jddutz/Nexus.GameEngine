...
namespace Tests
{
    public class ComponentFactoryTests
    {
        ...
        public void Create_TextElement_ResolvesGraphicsManagers()
        {
            ...
            services.AddSingleton<IDescriptorManager>(descriptorMock.Object);
            services.AddSingleton<IResourceManager>(resourceMock.Object);
            services.AddSingleton<IPipelineManager>(pipelineMock.Object);
