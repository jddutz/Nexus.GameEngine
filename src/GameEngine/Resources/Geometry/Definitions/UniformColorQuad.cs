...
/// <summary>
/// Position-only quad geometry definition for uniform color rendering.
/// Vertex format: Position(Vec2) = 8 bytes per vertex
/// Color is provided via push constants (not vertex data).
...
/// </summary>
public record UniformColorQuad : IGeometryDefinition
{
    /// <inheritdoc />
    public string Name => "UniformColorQuad";
    ...
    {
        // Return position data only (color comes from push constants)
